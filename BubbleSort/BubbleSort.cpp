// This program sorts array using bubble sort.
// Bubble Sort: the simplest sorting algorithm that
// works by repeatedly swapping the adjacent elements
// if they are in wrong order.
// The function without optimized always run O(n^2) time
// even if the array is sorted. But it can be optimized
// by stopping the algorithm if inner loop did'n cause any swap.
